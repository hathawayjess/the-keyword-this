//We're in a job interview. Answer the following questions (try to not look at your notes unless you have to).
  // 1) What is the purpose of the 'this keyword'?
      ...
      //Answer
      //The 'this' keyword allows you to reuse functions or methods in different contexts.
  ...
  // 3) What is the difference between call and apply?
      ...
      //Call and apply can both be called on functions. However, in call, the arguments are passed into the function as they are,
      //while apply expects the second argument to be an array that it will unpack as arguments for the function.
      //In short, apply uses an array and call requires parameters to be listed explicitly
...
//In the example above, what is the 'this keyword' bound to when getUsername runs?
  ...
  //It is bound to the window (its parent object).
